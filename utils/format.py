...
def generate_on_page(user,project_label):
    ...
    def on_page(canvas, doc):
        ...
        canvas.drawCentredString(page_width / 2, page_height - 40, "Data Summary Report")
...
def generate_on_page_deprecated(user,project_label,age_min,age_max,age_unit, threshold,input_labels):
    """Returns a function that can be used as a custom onPage callback."""
    def on_page(canvas, doc):
        page_width, page_height = A4
        border_margin = 20
